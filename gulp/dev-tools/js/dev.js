...
import Vue      from './3rd-party/vue.runtime.esm';
...
(function () {
    ...
    let source = {
        showPanel  : !!+localStorage.getItem(LS_SHOW_PANEL),
        pixelShow  : !!+localStorage.getItem(LS_PIXEL_SHOW),
        pixelInvert: !!+localStorage.getItem(LS_PIXEL_INVERT),
        showGrid   : !!+localStorage.getItem(LS_SHOW_GRID),
        showRhythm : !!+localStorage.getItem(LS_SHOW_RHYTHM),
        showOutline: !!+localStorage.getItem(LS_SHOW_OUTLINE),
    };

    document.documentElement.dataset.on      = +source.pixelShow;
    document.documentElement.dataset.invert  = +source.pixelInvert;
    document.documentElement.dataset.grid    = +source.showGrid;
    document.documentElement.dataset.rhythm  = +source.showRhythm;
    document.documentElement.dataset.outline = +source.showOutline;
